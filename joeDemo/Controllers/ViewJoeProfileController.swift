...
class ViewJoeProfileController: UIViewController {
    ...
    @IBOutlet weak var joeFace: UIImageView!
    ...
    @IBOutlet weak var joeDescription: UILabel!
    
    
    /*
       let storyboard : UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
    let vc = storyboard.instantiateViewController(withIdentifier: "ExploreController") as! ExploreController
